import allApps from './apps/_registry'
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)' }}>
      ...
      <div style={{
        ...
        {/* Apps section (commercial) */}
        {apps.filter(app => app.categoryType === 'commercial').length > 0 && (
          <div style={{ marginBottom: 80 }}>
            ...
            <div style={{
              ...
              {apps.filter(app => app.categoryType === 'commercial').map((app) => (
                <AppCard key={app.id} app={app} isCommercial />
              ))}
            </div>
          </div>
        )}

        {/* Showcase section (open-source) */}
        {apps.filter(app => !app.categoryType || app.categoryType !== 'commercial').length > 0 && (
          <div>
            <div style={{
              fontSize: 12,
              fontWeight: 700,
            ...
            <p style={{
              ...
              Open-source explorations in algorithms & science
            </p>
            ...
            <div style={{
              ...
              {apps.filter(app => !app.categoryType || app.categoryType !== 'commercial').map((app) => (
